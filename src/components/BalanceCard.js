    ...
    return (
        <View style={styles.container}>
            <View style={styles.blockContainer}>
                <Text style={[Typography.TAGLINE, {color: Colors.GRAY_THIN, marginBottom: 10}]}>Мой баланс</Text>
            ...
            <View style={styles.blockContainer}>
                <Text style={[Typography.TAGLINE, {color: Colors.GRAY_THIN, marginBottom: 10}]}>Всего потрачено</Text>
