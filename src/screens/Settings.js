        ...
        <View style={{flex: 1}}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
                ...
                <View style={styles.headerContainer}>
                    <Text style={[Typography.H1, {color: Colors.WHITE, marginBottom: 10}]}>Настойки</Text>
                </View>
                ...
                <View style={styles.bodyContainer}>
                    {/* Account */}
                    <View>
                        <Text style={[Typography.TAGLINE, {color: Colors.GRAY_MEDIUM, marginBottom: 10}]}>Аккаунт</Text>
                        <View style={styles.blockContainer}>
                            {/* Firstname */}
                            <View style={styles.rowContainer}>
                                <Text style={[Typography.BODY, {color: Colors.WHITE}]}>Имя</Text>
                                <Text style={[Typography.TAGLINE, {color: Colors.GRAY_MEDIUM}]}>{user.firstName}</Text>
                            </View>
                            <Bar padding={0.3} color={Colors.GRAY_THIN} /> 
                            {/* Lastname */}
                            <View style={styles.rowContainer}>
                                <Text style={[Typography.BODY, {color: Colors.WHITE}]}>Фамилия</Text>
                                <Text style={[Typography.TAGLINE, {color: Colors.GRAY_MEDIUM}]}>{user.lastName}</Text>
                            </View>
                            <Bar padding={0.3} color={Colors.GRAY_THIN} /> 
                            {/* Joined at */}
                            <View style={styles.rowContainer}>
                                <Text style={[Typography.BODY, {color: Colors.WHITE}]}>Зарегистрирован</Text>
                    ...
                    <View style={{marginTop: 20}}>
                        <Text style={[Typography.TAGLINE, {color: Colors.GRAY_MEDIUM, marginBottom: 10}]}>Настройки приложения</Text>
                        <View style={styles.blockContainer}>
                            <Pressable
                                style={styles.rowContainer}
                                onPress={() => __toggleCurrencyModal()}>
                                    <Text style={[Typography.BODY, {color: Colors.WHITE}]}>Валюта</Text>
                            ...
                            <TouchableOpacity 
                                activeOpacity={0.8}
                                style={styles.rowContainer}>
                                    <Text style={[Typography.BODY, {color: Colors.WHITE}]}>Язык</Text>
                                <Text style={[Typography.TAGLINE, {color: Colors.GRAY_MEDIUM}]}>Русский</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    {/* Privacy */}
                    <View style={{marginTop: 20}}>
                        <Text style={[Typography.TAGLINE, {color: Colors.GRAY_MEDIUM, marginBottom: 10}]}>О авторе</Text>
                        <View style={styles.blockContainer}>
                            <Pressable style={styles.rowContainer} onPress={() => Linking.openURL('https://www.vk.com/dezare')}>
                                <Text style={[Typography.BODY, {color: Colors.WHITE}]}>Разработчик</Text>
