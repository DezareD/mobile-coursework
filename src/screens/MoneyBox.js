    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
                <Text style={[Typography.H1, {color: Colors.WHITE, marginBottom: 10}]}>Копилка</Text>

                <TouchableOpacity
                    activeOpacity={0.7}
                    style={styles.iconContainer}
                    onPress={() => navigation.navigate(routes.AddMoneyBox)}>
                        <FontAwesomeIcon icon={faPlus} padding={12} style={{ color: "white" }} />
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.bodyContainer}>
                {moneybox.length == 0 ?
                    <View style={styles.emptyContainer}>
                        <Text style={[Typography.H3, {color: Colors.WHITE, textAlign: 'center'}]}>У вас нет активных копилок!</Text>
                    </View>
                :
                    <SwipeableFlatList
                        data={moneybox}
